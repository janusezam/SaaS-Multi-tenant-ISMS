...
use App\Tenancy\Bootstrappers\SafeCacheTenancyBootstrapper;
...
return [
    ...
    'bootstrappers' => [
        ...
        SafeCacheTenancyBootstrapper::class,
     ...
     */
    'seeder_parameters' => [
        '--class' => 'TenantRolesSeeder', // root seeder class
