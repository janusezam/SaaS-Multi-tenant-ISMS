<x-guest-layout>
    <div class="mb-5">
        <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Central App</p>
        <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-100">Super Admin Sign In</h1>
    </div>
