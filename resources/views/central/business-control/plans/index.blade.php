    ...
    <div class="mx-auto max-w-7xl space-y-5 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-900/80">
            ...
            <form method="POST" action="{{ route('central.business-control.plans.store') }}" class="mt-4 grid gap-3 md:grid-cols-3">
                ...
                <input type="number" step="0.01" min="0" max="100" name="yearly_discount_percent" placeholder="yearly discount %" class="w-full rounded-xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 dark:border-white/10 dark:bg-slate-950/60 dark:text-slate-100">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <form method="POST" action="{{ route('central.business-control.plans.update', $plan) }}" class="grid gap-2 lg:grid-cols-4">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" name="yearly_discount_percent" value="{{ $plan->yearly_discount_percent }}" class="rounded border border-slate-300 bg-white text-slate-900 dark:border-white/10 dark:bg-slate-950/60 dark:text-slate-100">
