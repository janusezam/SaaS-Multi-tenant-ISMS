        ...
        <div class="rounded-2xl border border-white/10 bg-slate-900/85 p-6">
            <form method="POST" action="{{ route('central.universities.update', $university) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="school_address" name="school_address" value="{{ old('school_address', $university->school_address) }}" class="w-full rounded-xl border border-white/10 bg-slate-950/60 text-slate-100" required />
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="tenant_admin_name" name="tenant_admin_name" value="{{ old('tenant_admin_name', $university->tenant_admin_name) }}" class="w-full rounded-xl border border-white/10 bg-slate-950/60 text-slate-100" required />
                    ...
                    <div>
                        ...
                        <input id="tenant_admin_email" type="email" name="tenant_admin_email" value="{{ old('tenant_admin_email', $university->tenant_admin_email) }}" class="w-full rounded-xl border border-white/10 bg-slate-950/60 text-slate-100" required />
