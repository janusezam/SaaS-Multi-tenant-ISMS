                ...
                <div>
                    ...
                    <select id="player_user_id" name="player_user_id" class="w-full rounded-xl border border-white/10 bg-slate-950/60 text-slate-100">
                        ...
                        @foreach ($playerUsers as $playerUser)
                            <option value="{{ $playerUser->id }}" data-player-name="{{ $playerUser->name }}" data-player-email="{{ $playerUser->email }}" @selected(old('player_user_id') == $playerUser->id)>{{ $playerUser->name }} ({{ $playerUser->email }})</option>
                        @endforeach
                    </select>
